    ...
    return (
      <button
        className={cn(
          ...
          variant === "ghost" && "hover:bg-secondary hover:text-accent-foreground",
          variant === "outline" && "bg-transparent border border-input hover:bg-secondary hover:text-accent-foreground",
